                ...
                dataTable: {
                    ...
                    "ajax": { // define ajax settings
                        ...
                        "data": function (data) { // add request parameters before submit
                            ...
                            alert(ajaxParams);
                            return "dataTableAjaxParam=" + JSON.stringify(data) + "&customAjaxParam=" + JSON.stringify(ajaxParams);
                        },
